...
public:
    ...
    double calculateSLM(double voltage) {
        //double val = (voltage*voltage*457.528-voltage*183.361+14.1590) * getSelectedGas().getThermalConductivity();
        double val = (voltage*voltage*m_slope + voltage*m_intercept + m_secondp) * getSelectedGas().getThermalConductivity();
